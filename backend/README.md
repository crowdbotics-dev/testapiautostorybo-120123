...
## Project Structure
    ...
    ├── testapiautostorybo_120123  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_120123`
...
2. Clone this repo and `cd testapiautostorybo_120123`
